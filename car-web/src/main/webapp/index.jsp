...
<head>
  ...
  <title>Software Cadastro de Carros</title>
<!--
  ...
  <div class="tm-main-container">
    ...
    <div class="tm-top-container">
      ...
      <header class="tm-site-header-box tm-bg-dark">
        <h1 class="tm-site-title">CARROS</h1>
        <p class="mb-0 tm-site-subtitle"><a href="cadastrarCarros.jsp" style="text-decoration: none; color: green">Aqui Você pode Ter Acesso ao Software</a></p>
      </header>
    </div>
    <!-- tm-top-container -->
        ...
        <div class="col-md-12">
          ...
          <div class="tm-content">
            ...
            <section class="tm-section tm-section-0">
              <h2 class="tm-section-title mb-3 font-weight-bold">Introdução</h2>
              <div class="tm-textbox tm-bg-dark">
                <p>Software Web Para Listar Carros, Cadastrar Carros, Atualizar Carros e Deletar Carros </p>
                <p class="mb-0">Esse software Tem A Facilidade Para Tais Opções</p>
              </div>
            </section>
    ...
    <div class="tm-bottom-container">
      ...
      <!-- Footer -->
      <footer>
        || Copyright &copy; 2023 Carros NetShow
        
        || design: <a rel="nofollow" href="https://github.com/KellaoDev/" class="tm-footer-link">Kellao</a> 

        || distribution: <a href="https://github.com/KellaoDev/" class="tm-footer-link">NetShow</a> ||
      </footer>
    </div>
  </div>
